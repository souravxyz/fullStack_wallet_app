      ...
      >
        <div className="backdrop-blur-lg bg-white/30 dark:bg-gray-800/30 p-8 rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/20">
          <div className="flex flex-col items-center mb-6">
            ...
            >
              <div className="w-20 h-20 rounded-full bg-gradient-to-r from-blue-400 to-purple-500 flex items-center justify-center overflow-hidden border-2 border-white/30 shadow-lg">
                {preview ? (
                  <img
                    src={preview}
                    alt="Preview"
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {password && password.length > 0 && (
                <div className="mt-2 h-1.5 rounded-full overflow-hidden bg-gray-200 dark:bg-gray-700">
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{
                      width: `${Math.min(100, (password.length / 6) * 100)}%`,
                    }}
                    className={`h-full ${
                      password.length >= 6 ? "bg-green-500" : "bg-yellow-500"
                    }`}
                  />
                </div>
              )}
            ...
            <p className="text-center text-gray-600 dark:text-gray-300">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 font-medium inline-block"
              >
                Login here
              </motion.a>
            </p>
